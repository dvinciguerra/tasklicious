...
__PACKAGE__->belongs_to('assigned_to', 'Tasklicious::Model::Result::User', {id => 'assigned'});
__PACKAGE__->has_one('project', 'Tasklicious::Model::Result::Project', {'foreign.id' => 'self.project_id'});
